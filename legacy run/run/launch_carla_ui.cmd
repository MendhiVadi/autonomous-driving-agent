...
if errorlevel 1 (
    "%CARLA_PYTHON%" "%APP_ROOT%app\runtime\health.py"
    if errorlevel 1 (
        echo.
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%APP_ROOT%scripts\start_stack_supervisor.ps1" ^
...
echo this window or its parent process closes.
